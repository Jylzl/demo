		...
		<div class="land-box-center">
			...
			<div class="user-header-img">
				<pan-thumb width="100px" height="100px"
					image="https://wpimg.wallstcn.com/577965b9-bb9e-4e02-9f0c-095b41417191"></pan-thumb>
			...
			<div class="land-form">
				<el-form :model="landForm_password" ref="landForm_password" class="demo-ruleForm">
					<el-form-item prop="user" :rules="rules.user">
						<el-input type="text" v-model.number="landForm_password.user" autocomplete="off"
							placeholder="手机号/邮箱/用户名" :readonly=true></el-input>
					</el-form-item>
					<el-form-item prop="pswd" :rules="rules.pswd">
						<div class="show-pswd">
							<el-input :type="pswdType" v-model.number="landForm_password.pswd" autocomplete="off"
								placeholder="密码" maxlength="16" class="show-pswd-input"
								@keyup.enter.native="submitForm('landForm_password')"></el-input>
							<el-button type="text" class="show-pswd-btn" title="显示密码"><i class="el-icon-view"
									@mousedown="showPswd('text')" @mouseup="showPswd('password')"></i></el-button>
						</div>
					</el-form-item>
					<el-form-item style="margin-bottom:0;">
						<el-button type="primary" @click="submitForm('landForm_password')" style="width:100%;"
							:disabled="landLoading.disabled" :icon="landLoading.icon">{{landLoading.content}}
						</el-button>
					</el-form-item>
				</el-form>
			</div>
...
<script>
	...
	export default {
		components: {},
		data() {
			let r_user = va.required('用户名不能为空');
