  ...
  data() {
    return {
      ...
      init: {
        ...
        toolbar:
          "undo redo | formatpainter | formatselect | fontselect fontsizeselect | bold italic underline strikethrough subscript superscript removeformat | forecolor backcolor | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent indent2em | lists image media emoticons link charmap codesample table | bdmap lineheight enclosure | a11ycheck | fullscreen"
      }
    };
  },
  methods: {
