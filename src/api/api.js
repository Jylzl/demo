...
const api = {
    userLogin: '/api/login', //登录 
    userLoginout: '/api/logout', //退出登录
    getPerms: '/api/getMenuByUser', // 获取用户权限getPerms

    //用户管理
    userAdd: '/api/system/user/insert', //用户添加
    userDel: '/api/system/user/remove', //用户删除
    userUpdate: '/api/system/user/update', //用户修改

    //角色管理
    roleAdd: '/api/system/role/insert', //角色增加
    roleDel: '/api/system/role/remove', //角色删除
    roleUpdate: '/api/system/role/update', //角色修改
    roleList: '/api/system/role/list', //角色列表

    //菜单管理
    meunAdd: "/api/system/menu/insert", //菜单增加
    meunDel: "/api/system/menu/remove", //菜单删除
    meunUpdate: "/api/system/menu/update", //菜单修改
    meunList: "/api/system/menu/list", //菜单列表
    menuTree: "/api/system/menu/menuTreeData", //菜单树
    getMenuByRole: '/api/system/menu/roleMenuTreeData', // 根据角色获取树

    //部门管理
    departmentAdd: "/api/system/dept/insert", //部门增加
    departmentDel: "/api/system/dept/remove", //部门删除
    departmentUpdate: "/api/system/dept/update", //部门修改
    departmentTree: "/api/system/dept/treeData", //部门树

    // 日志管理
    logs: "/api/system/operlog/list", //日志管理

    // 词库管理--敏感词管理
    sensitiveAdd: "/api/system/lexicon/sensitive/insert", //敏感词增加
    sensitiveDel: "/api/system/lexicon/sensitive/remove", //敏感词删除
    sensitiveUpdate: "/api/system/lexicon/sensitive/update", //敏感词修改
    sensitiveList: "/api/system/lexicon/sensitive/list", //敏感词列表

    // 词库管理--错别字管理
    mistypingAdd: "/api/system/lexicon/mistyping/insert", //错别字增加
    mistypingDel: "/api/system/lexicon/mistyping/remove", //错别字删除
    mistypingUpdate: "/api/system/lexicon/mistyping/update", //错别字修改
    mistypingList: "/api/system/lexicon/mistyping/list", //错别字列表

    //资源管理--资源同步
    syncTree: "/api/portalSite/channelTree.do", //获取目录树
    queryResource: "/api/resource/sychron/queryResource.do", //获取资源列表
    getSynchronParameters: "/api/resource/sychron/getSynchronParameters.do", //获取资源树和类别
    batchSychron: "/api/resource/sychron/batchSychron.do", //资源同步

    // 资源模型--标签管理
    getAllType: "/api/tagType/getAll", //获得所有类别
    getAllImg: "/api/tagBackground/getAll", //获得所有背景图片
    doTagAdd: "/api/tag/add", //标签添加
    getTagList: "/api/tag/page", //获得标签列表
    doTagUpdate: "/api/tag/update", //标签修改更新
    doTagdel: "/api/tag/delete", //标签删除

    // 资源模型--标签管理--标签类型管理
    getTagPage: "/api/tagType/page", //类型分页
    tagTypeUpdate: "/api/tagType/update", //类型修改
    getTagType: "/api/tagType/getTagType", //根据id得到单个类型详情
    tagTypeDel: "/api/tagType/delete", //类型删除
    tagTypeAdd: "/api/tagType/add", //类型添加
