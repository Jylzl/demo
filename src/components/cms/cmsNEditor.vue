  ...
  methods: {
    ...
    _initEditor(value) {
      ...
      this.$nextTick(() => {
        ...
        _this.readyValue = value;
        _this.editor.addListener("ready", () => {
          _this.isReady = true;
          _this.$emit("ready", _this.editor);
          _this.editor.setContent(_this.readyValue);
