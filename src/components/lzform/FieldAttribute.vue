	...
	<div class="field-attribute">
		<el-form label-position="left" label-width="84px" :model="o_config" size="small" label-suffix="：">
			...
			<el-form-item label="字段标题">
				<el-input v-model="o_config.label" placeholder="请输入字段标题" maxlength="100" clearable></el-input>
			</el-form-item>
			<el-form-item label="字段名称">
				<el-input v-model="o_config.prop" placeholder="请输入字段名称" maxlength="100" clearable></el-input>
			</el-form-item>
			...
			<el-form-item label="占位内容">
				<el-input v-model="o_config.placeholder" placeholder="请输入占位内容" maxlength="100" clearable></el-input>
			</el-form-item>
			<el-form-item label="默认内容">
				<el-input v-model="o_config.valueDefault" placeholder="请输入默认内容" maxlength="100" clearable></el-input>
			</el-form-item>
			...
			<el-form-item label="请求地址" v-if="o_config.dataSources == 'online'">
				<el-input v-model="o_config.requiredUrl" placeholder="请输入请求地址" maxlength="100" clearable></el-input>
			</el-form-item>
			<el-form-item label="静态数据" v-if="o_config.dataSources == 'local'">
				<el-input v-model="o_config.localData" placeholder="请配置静态数据" maxlength="100" clearable>
			...
			<el-form-item label="校验正则" v-if="o_config.check && o_config.checkType == '0'">
				<el-input v-model="o_config.regex" placeholder="请输入校验正则表达式" maxlength="100" clearable></el-input>
			</el-form-item>
		</el-form>
	</div>
</template>
