  ...
  <div class="field-attribute">
    ...
    >
      <el-form-item label="字段类型">
        <el-select
          v-model="fieldAttribute.fieldType"
          placeholder="请选择字段类型"
        >
          <el-option
      ...
      <el-form-item label="占位内容">
        <el-input
          v-model="fieldAttribute.placeholder"
          placeholder="请输入占位内容"
          maxlength="100"
          clearable
        ></el-input>
      ...
      <el-form-item label="默认内容">
        <el-input
          v-model="fieldAttribute.valueDefault"
          placeholder="请输入默认内容"
          maxlength="100"
          clearable
        ></el-input>
      ...
      <el-form-item label="最大长度">
        <el-input-number
          v-model="fieldAttribute.maxlength"
          controls-position="right"
          :min="0"
          :step="10"
          :max="3000"
      ...
      <el-form-item label="最小长度">
        <el-input-number
          v-model="fieldAttribute.minlength"
          controls-position="right"
          :min="0"
          :step="10"
          :max="3000"
      ...
      <el-form-item label="数据来源">
        <el-select
          v-model="fieldAttribute.dataSources"
          placeholder="请选择数据来源"
        >
      ...
      <el-form-item label="数据类型">
        <el-select
          v-model="fieldAttribute.dataType"
          placeholder="请选择数据类型"
        >
      ...
      <el-form-item
        label="请求方式"
        v-if="fieldAttribute.dataSources == 'online'"
      >
        <el-select
          v-model="fieldAttribute.requestType"
          placeholder="请选择请求方式"
        >
      ...
      >
        <el-input
          v-model="fieldAttribute.requiredUrl"
          placeholder="请输入请求地址"
          maxlength="100"
          clearable
        >
      ...
      <el-form-item
        label="静态数据"
        v-if="fieldAttribute.dataSources == 'local'"
      >
        <el-input
          v-model="fieldAttribute.localData"
          placeholder="请配置静态数据"
          maxlength="100"
          clearable
        >
      ...
      <el-form-item label="校验类型" v-if="fieldAttribute.check">
        <el-select
          v-model="fieldAttribute.checkType"
          placeholder="请选择校验类型"
        >
          <el-option
      ...
      <el-form-item
        label="校验正则"
        v-if="fieldAttribute.check && fieldAttribute.checkType == '0'"
      >
        <el-input
          v-model="fieldAttribute.regex"
