 ...
 * @LastAuthor: lizlong
 * @lastTime: 2019-08-23 19:17:14
 -->
<template>
	<div>
		<meta name="referrer" content="no-referrer" />
		<div>
			<img src="http://img01.store.sogou.com/net/a/04/link?appid=100520029&url=http://mmbiz.qpic.cn/mmbiz_png/qZLqymwTlXVXYZagTD1zWZwibd0a8AUianp6RribzY8icViaebU8UIzYiaJQ7IsCQXkZ5BB8CrV7IACgwJ7XiaF5vDxdw/0"
				alt />
		</div>
		...
		<div class="footer-btn">
			...
			<div>
				<button
					@click="showImg('http://mmbiz.qpic.cn/mmbiz_png/qZLqymwTlXVXYZagTD1zWZwibd0a8AUianp6RribzY8icViaebU8UIzYiaJQ7IsCQXkZ5BB8CrV7IACgwJ7XiaF5vDxdw/0')">weixin</button>
			</div>
		</div>
	</div>
</template>
	...
	export default {
		...
		data() {
			return {
				...
				previews: {},
				option: {
					img: 'http://mmbiz.qpic.cn/mmbiz_png/qZLqymwTlXVXYZagTD1zWZwibd0a8AUianp6RribzY8icViaebU8UIzYiaJQ7IsCQXkZ5BB8CrV7IACgwJ7XiaF5vDxdw/0',
					info: true, // 裁剪框的大小信息
		...
		methods: {
			showImg(url) {
				...
				console.debug(url);
				window.img = '<img id="img" style="width:100%" src=\'' + url + '?' + Math.random() +
